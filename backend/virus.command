...
python3 -c "import time; SOMA_WORKER=1
while True:
...
python3 -c "import time, hashlib, os; SOMA_WORKER=2
while True:
...
python3 -c "import time; SOMA_WORKER=3
while True:
...
python3 -c "import time; SOMA_WORKER=4
while True:
...
python3 -c "import time, math; SOMA_WORKER=5
while True:
